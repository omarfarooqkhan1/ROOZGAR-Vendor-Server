...
router.get("/getReviews/:_id", async (req, res) => {
  ...
  try {
    ...
    let response = await axios.post('http://93a0-103-255-7-49.ngrok.io/sentiment', payload);
...
router.get("/getSubCategories/", async (req, res) => {
  try {
    ...
    let response = await axios.post('http://93a0-103-255-7-49.ngrok.io/nlp', payload);
